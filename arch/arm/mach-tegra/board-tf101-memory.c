...
#endif /* !CONFIG_TEGRA_OVERCLOCK */

static const struct tegra_emc_chip tf101_elpida_emc_chips[] = {
	{
		...
		.mem_revision_id2 = -1,
		.mem_pid = 0x5454,
		.table = tf101_emc_tables_elpida_300Mhz,
		.table_size = ARRAY_SIZE(tf101_emc_tables_elpida_300Mhz)
	},
};

int tf101_emc_init(void)
{
	tegra_init_emc(tf101_elpida_emc_chips, ARRAY_SIZE(tf101_elpida_emc_chips));
	return 0;
}
